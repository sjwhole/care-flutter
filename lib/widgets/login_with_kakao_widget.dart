...
class LoginWithKakaoWidget extends StatefulWidget {
  const LoginWithKakaoWidget({super.key});

  @override
  State<LoginWithKakaoWidget> createState() => _LoginWithKakaoWidgetState();
}

class _LoginWithKakaoWidgetState extends State<LoginWithKakaoWidget> {
  bool _isShimmering = false;

  void _toggleShimmerEffect() {
    setState(() {
      _isShimmering = true;
    });

    // Turn off shimmer effect after 2 seconds
            ...
            onTap: () async {
              ...
              try {
                ...
                try {
                  ...
                  toastMessage(
                      context, "다시오신 것을 환영해요 ${user.kakaoAccount?.name}님!");
                  // try {
